...
public class DangNhap_GUI extends JFrame implements ActionListener{
    ...
    public DangNhap_GUI() {
        ...
        lblLogo.setIcon(scaleIcon("/img/logo.jpg", 200, 150)); // ✅ dùng scaleIcon()
        pnlTop.add(lblLogo);
        ...
        lblTenDangNhap.setFont(new Font("Arial", Font.BOLD, 16));
        lblTenDangNhap.setBounds(80, 20, 200, 25);
        pnlCenter.add(lblTenDangNhap);

        txtTenDangNhap = new JTextField();
        txtTenDangNhap.setFont(new Font("Arial", Font.PLAIN, 15));
        txtTenDangNhap.setBounds(80, 50, 290, 34);
        pnlCenter.add(txtTenDangNhap);

        JLabel iconUser = new JLabel(scaleIcon("/img/user.png", 33, 33)); // ✅
        ...
        txpPassClose.setFont(new Font("Arial", Font.PLAIN, 15));
        txpPassClose.setBounds(80, 130, 290, 34);
        pnlCenter.add(txpPassClose);

        txtPassOpen = new JTextField();
        txtPassOpen.setFont(new Font("Arial", Font.PLAIN, 15));
        txtPassOpen.setBounds(80, 130, 290, 34);
        txtPassOpen.setVisible(false);
        pnlCenter.add(txtPassOpen);

        imgEye = new JLabel(scaleIcon("/img/eye.png", 34, 34)); // ✅
        ...
        imgEye.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (hienMatKhau) {
                    ...
                    imgEye.setIcon(scaleIcon("/img/closed-eyes.png", 34, 34)); // ✅
                } else {
                    txpPassClose.setText(txtPassOpen.getText());
                    txtPassOpen.setVisible(false);
                    txpPassClose.setVisible(true);
                    imgEye.setIcon(scaleIcon("/img/eye.png", 34, 34)); // ✅
                }
            }
        });
